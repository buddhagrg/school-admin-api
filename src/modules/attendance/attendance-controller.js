...
const handleGetStudentsForAttendance = asyncHandler(async (req, res) => {
  ...
  const data = await processGetStudentsForAttendance({
    ...payload,
    schoolId,
  });
  res.json({ data });
...
const handleGetStaffsForAttendance = asyncHandler(async (req, res) => {
  const payload = req.query;
  const { schoolId } = req.user;
  const data = await processGetStaffsForAttendance({
    ...payload,
    schoolId,
  });
  res.json({ data });
...
const handleAddOrUpdateAttendance = asyncHandler(async (req, res) => {
  ...
  const message = await processAddOrUpdateAttendance({
    ...payload,
    schoolId,
    attendanceRecorder,
  });
...
const handleGetStudentsAttendanceRecord = asyncHandler(async (req, res) => {
  const payload = req.query;
  const { schoolId } = req.user;
  const data = await processGetStudentsAttendanceRecord({
    ...payload,
    schoolId,
  });
  res.json({ data });
...
const handleGetStaffsAttendanceRecord = asyncHandler(async (req, res) => {
  const payload = req.query;
  const { schoolId } = req.user;
  const data = await processGetStaffsAttendanceRecord({
    ...payload,
    schoolId,
  });
  res.json({ data });
